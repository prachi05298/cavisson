                ...
                if(curUrlArray[2] == "blog.mygov.in" || curUrlArray[2] == "quiz.mygov.in"){ 
                    ...
                    if(urlArray[2] == curUrlArray[2]){
                        ...
                        var baseDomn = urlSpArr[urlSpArr.length-2]+'.'+urlSpArr[urlSpArr.length-1];                
                         if(urlArray[2] == "staging.mygov.in" || urlArray[2] == "demo.mygov.in" || urlArray[2] == "preprod.mygov.in" || urlArray[2] == "preprodauth.mygov.in" || urlArray[2] == "wwww.mygov.in"  || urlArray[2] == "mygov.in"  || urlArray[2] == "auth.mygov.in"  || urlArray[2] == "secure.mygov.in" ||  urlArray[2] == curUrlArray[2]){
