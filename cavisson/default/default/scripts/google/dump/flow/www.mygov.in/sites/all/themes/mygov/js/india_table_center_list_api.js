...
function searchKeyAPICenter(sDate = '') {
    ...
    var gatData = 'https://api.mygov.in/get-vaccination-center/?api_key=57076294a5e2ab7fe0000001dd278c47e313412c7de416e536f1992f&page=0&page_size=200'+str;
                    ...
                    if(sDate == ''){
                        ...
                        if(value['sessions_list'][sDate] === undefined)
                        {
                            ...
                            for(var i = 0; i < value['sessions_list'][sDate].length; i++){
                               ...
                               // if(a[k]['available_capacity_dose1'] >= 0){
                                     tableData += '<tr><td>'+a[k]['name']+'</td><td>'+a[k]['location']+'</td><td>'+a[k]['vaccine_name']+'</td><td>'+val['min_age_limit']+'</td><td><div class="d1"><strong>D1</strong><br />'+val['available_capacity_dose1']+'</div><div class="d2"><strong>D2</strong><br />'+val['available_capacity_dose2']+'</div></td><td>'+a[k]['fee_type']+'</td><td>'+val['date']+'</td></tr>';
                               /* }
                                if(a[k]['available_capacity_dose2'] >= 0){
